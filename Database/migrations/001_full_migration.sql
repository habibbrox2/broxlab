-- =============================================================================
-- AI Auto Content - Complete Database Migration
-- =============================================================================
-- This file contains all the necessary SQL statements to create and set up
-- the database tables for the AI Auto Content system including scraper features
-- =============================================================================
...
INSERT IGNORE INTO `categories` (`name`, `slug`, `description`, `order`, `status`) VALUES
...
-- Insert sample autocontent sources (Bangladeshi news sites)
INSERT IGNORE INTO `autocontent_sources` (`name`, `url`, `type`, `category_id`, `selector_list_container`, `selector_list_item`, `selector_list_title`, `selector_title`, `selector_content`, `selector_image`, `pagination_type`, `fetch_interval`, `is_active`) VALUES
...
-- Insert sample posts
INSERT IGNORE INTO `posts` (`title`, `slug`, `content`, `excerpt`, `category_id`, `status`, `published_at`, `created_at`) VALUES
('Welcome to AI Auto Content', 'welcome-to-ai-auto-content', '<p>Welcome to your AI-powered auto content system. This system can automatically scrape content from various sources, enhance it with AI, and publish to your blog.</p><h2>Features</h2><ul><li>Automatic content scraping from multiple sources</li><li>AI-powered content enhancement</li><li>SEO optimization</li><li>Automatic duplicate detection</li><li>Multi-language support</li></ul>', 'Welcome to your AI-powered auto content system.', 6, 'published', NOW(), NOW()),
('Getting Started Guide', 'getting-started-guide', '<p>This guide will help you get started with the AI Auto Content system.</p><h2>Setup</h2><p>Configure your scraping sources from the admin panel and start collecting content.</p>', 'Learn how to set up and use the AI Auto Content system.', 6, 'published', NOW(), NOW());
